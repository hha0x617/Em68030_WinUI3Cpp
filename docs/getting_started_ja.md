...
| ガイド | 説明 |
|--------|------|
| [フレームバッファディスプレイ](https://github.com/hha0x617/Em68030-Guest-Linux/blob/main/docs/setup_framebuffer_ja.md) | フレームバッファコンソール (fbcon) と X Window System のセットアップ (Em68030-Guest-Linux) |
