...
For framebuffer console setup and X Window System configuration, see the
[Framebuffer Display Setup Guide](https://github.com/hha0x617/Em68030-Guest-NetBSD/blob/main/docs/setup_framebuffer.md) (Em68030-Guest-NetBSD).
